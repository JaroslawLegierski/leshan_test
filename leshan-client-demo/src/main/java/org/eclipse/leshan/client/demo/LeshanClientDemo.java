...
public class LeshanClientDemo {
    ...
    public static LeshanClient createClient(LeshanClientDemoCLI cli, LwM2mModelRepository repository) throws Exception {
        ...
        if (cli.oscore != null) {
            ...
            // TODO OSCORE change oscore object to use byte[] instead of String.
            Oscore oscoreObject = new Oscore(oscoreObjectInstanceId, cli.oscore.masterSecret.getAsString(),
                    cli.oscore.senderId.getAsString(), cli.oscore.recipientId.getAsString(), cli.oscore.aeadAlgorithm,
                    cli.oscore.hkdfAlgorithm, cli.oscore.masterSalt.getAsString());
